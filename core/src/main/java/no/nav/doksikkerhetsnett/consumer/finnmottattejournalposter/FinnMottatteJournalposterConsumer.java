    ...
    public FinnMottatteJournalposterResponse finnMottateJournalposter(String temaer) {
        try {
            ...
            if (HttpStatus.NOT_FOUND.equals(e.getStatusCode())) {
                ...
                throw new FinnMottatteJournalposterFunctionalException(String.format("finnMottateJournalposter feilet funksjonelt med statusKode=%s. Feilmelding=%s. Url=%s", e
                        .getStatusCode(), e.getMessage(), finnMottatteJournalposterUrl), e);
            }
