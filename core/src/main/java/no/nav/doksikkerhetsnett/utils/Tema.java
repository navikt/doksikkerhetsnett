...
public class Tema {
	...
	@Getter
	private static final Set<String> alleTema = Set.of("AAP", "AAR", "AGR", "AKT", "ARP", "ARS", "BAR", "BBF", "BID", "BIL", "DAG", "ENF", "ERS", "EYB", "EYO", "FAR", "FEI", "FIP", "FOR", "FOS", "FUL", "FRI", "GEN", "GRA", "GRU", "HEL", "HJE", "IAR", "IND", "KLL", "KON", "KTA", "KTR", "MED", "MOB", "OLJ", "OMS", "OPA", "OPP", "PAI", "PEN", "PER", "POI", "REH", "REK", "RPO", "RVE", "SAA", "SAK", "SAP", "SER", "STO", "SUP", "SYK", "SYM", "TIL", "TRK", "TRY", "TSO", "TSR", "UFM", "UFO", "UKJ", "UNG", "VEN", "YRA", "YRK");
